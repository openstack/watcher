    ...
    *Limitations*
        ...
        for nodemap in hosts:
            ...
            if source_instances:
                ...
                if (
                    ...
                    and inlet_temp < self.threshold_inlet_t
                ):
                ...
                LOG.info("Instance not found on node: %s", source_node.uuid)
    ...
    def filter_destination_hosts(self, hosts, instances_to_migrate):
            ...
            for nodemap in hosts:
                ...
                if 'cores_used' not in nodemap:
                    ...
                    (
                        ...
                        nodemap['mem_used'],
                        nodemap['disk_used'],
                    ) = self.calculate_used_resource(host)
        ...
        if len(destination_hosts) != len(instances_to_migrate):
            LOG.warning(
                "Not all target hosts could be found; it might "
    ...
    def do_execute(self, audit=None):
        ...
        if not target_nodes:
            LOG.warning(
                "No hosts currently have airflow under %s, "
        ...
        if not destination_hosts:
            LOG.warning(
                "No target host could be found; it might "
        ...
        for info in destination_hosts:
            ...
            if self.compute_model.migrate_instance(
                ...
                self.add_action_migrate(
                    instance, 'live', source_node, destination_node
                )
