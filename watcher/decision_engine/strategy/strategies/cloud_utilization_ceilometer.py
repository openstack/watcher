...
from ceilometerclient import exc as exce
from watcher.datasource import ceilometer
from watcher.decision_engine.model import element
from watcher.common import nova_helper


class CloudUtilizationCeilometer(base.CloudUtilizationBaseStrategy):
    ...
    def ceilometer(self):
        if self._ceilometer is None:
            self._ceilometer = ceilometer.CeilometerHelper(osc=self.osc)
    ...
    @classmethod
    def get_name(cls):
        return "cloud_utilization_ceilometer"
    ...
    def get_display_name(cls):
        return _("Cloud Utilization Ceilometer")

    @classmethod
    def get_translatable_display_name(cls):
        return "Cloud Utilization Ceilometer"
    ...
    def get_node_cpu_usage(self,node):
        metric_name = self.METRIC_NAMES[
            'ceilometer']['host_cpu_usage']

        #pdb.set_trace()
        statistics = self.ceilometer.statistic_aggregation(
    ...
    def get_node_memory_usage(self,node):
        metric_name = self.METRIC_NAMES['ceilometer']['host_ram_free']
