...
fake_scope_1 = [
    {
        'compute': [
            {'availability_zones': [{'name': 'AZ1'}, {'name': 'AZ3'}]},
            {'exclude': [{'instances': [{'uuid': 'INSTANCE_6'}]}]},
        ]
    }
]
...
fake_scope_2 = [
    {
        'storage': [
            {'availability_zones': [{'name': 'zone_0'}]},
            {
                'exclude': [
                    {'volumes': [{'uuid': vum['volume_1']}]},
...
fake_scope_3 = [
    {'compute': [{'host_aggregates': [{'id': '1'}]}, {'exclude': []}]}
]
