...
from watcher.applier.actions import delete
from watcher.common import exception
from watcher.tests.unit import base
from watcher.tests.unit.common import utils as test_utils


class TestDelete(test_utils.NovaResourcesMixin, base.TestCase):
    ...
    def setUp(self):
        ...
        self.action = delete.Delete(mock.Mock())
    ...
    def test_pre_condition_instance_exists(self):
    ...
    def test_execute_success(self):
        self.m_helper.delete_instance.return_value = True

        result = self.action.execute()

        self.assertTrue(result)
        self.m_helper.delete_instance.assert_called_once_with(
            instance_id=self.INSTANCE_UUID
        )

    def test_execute_failure(self):
        self.m_helper.delete_instance.return_value = False
    ...
    def test_execute_nova_client_error(self):
        self.m_helper.delete_instance.side_effect = exception.NovaClientError(
    ...
    def test_execute_unexpected_exception(self):
        self.m_helper.delete_instance.side_effect = Exception("Unexpected")

        result = self.action.execute()

        self.assertFalse(result)

    def test_revert_returns_false(self):
