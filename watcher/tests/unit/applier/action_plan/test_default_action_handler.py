...
class TestDefaultActionPlanHandler(base.DbTestCase):
    ...
    def setUp(self):
        ...
        self.action_plan = obj_utils.create_test_action_plan(
            self.context, audit_id=self.audit.id, strategy_id=self.strategy.id
        )
    ...
    def test_launch_action_plan(self, m_get_action_plan):
        ...
        self.assertEqual(
            expected_calls,
            self.m_action_plan_notifications.send_action_notification.call_args_list,
        )
    ...
    @mock.patch.object(ap_applier.DefaultApplier, "execute")
    @mock.patch.object(objects.ActionPlan, "get_by_uuid")
    def test_cancel_action_plan_with_exception(
        self, m_get_action_plan, m_execute
    ):
        m_get_action_plan.return_value = self.action_plan
    ...
    def test_launch_action_plan_failed_actions(
        self, m_action_list, m_get_action_plan
    ):
        m_get_action_plan.return_value = self.action_plan
    ...
    @mock.patch.object(objects.ActionPlan, "get_by_uuid")
    def test_launch_action_plan_skipped_actions(self, m_get_action_plan):
        m_get_action_plan.return_value = self.action_plan
        ...
        self.assertEqual(ap_objects.State.SUCCEEDED, self.action_plan.state)
        self.assertEqual(
            self.action_plan.status_message,
    ...
    @mock.patch.object(objects.ActionPlan, "get_by_uuid")
    def test_launch_action_plan_manual_skipped_actions(
        self, m_get_action_plan
    ):
        m_get_action_plan.return_value = self.action_plan
        skipped_action = obj_utils.create_test_action(
            self.context,
