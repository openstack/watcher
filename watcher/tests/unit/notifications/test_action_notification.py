...
class TestActionNotification(base.DbTestCase):
    def setUp(self):
        ...
        self.audit = utils.create_test_audit(
            mock.Mock(), strategy_id=self.strategy.id
        )
    ...
    def test_send_action_update(self):
        action = utils.create_test_action(
            ...
            action_type='nop',
            input_parameters={'param1': 1, 'param2': 2},
            parents=[],
        ...
        self.assertDictEqual(
            {
                ...
                'watcher_object.data': {
                    ...
                    'input_parameters': {'param2': 2, 'param1': 1},
    ...
    def test_send_action_plan_create(self):
        ...
        notifications.action.send_create(
    ...
    def test_send_action_delete(self):
        action = utils.create_test_action(
            mock.Mock(),
            state=objects.action.State.DELETED,
            action_type='nop',
            input_parameters={'param1': 1, 'param2': 2},
            parents=[],
            action_plan_id=self.action_plan.id,
        )
        notifications.action.send_delete(
            mock.MagicMock(), action, host='node0'
        )
                    ...
                    'watcher_object.data': {
                        ...
                        'fault': {
                            'watcher_object.data': {
                                ...
                                'module_name': (
                                    'watcher.tests.unit.notifications.'
